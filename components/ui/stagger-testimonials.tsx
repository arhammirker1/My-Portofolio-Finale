...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ position, testimonial, handleMove, cardSize }) => {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCenter
          ...
          : "z-0 bg-black text-white border-border/40 hover:border-border/70",
      )}
      style={{
        width: cardSize,
        height: cardSize,
    ...
    >
      <span
        className={cn("absolute block origin-top-right rotate-45", isCenter ? "bg-black" : "bg-white/20")}
        style={{
          right: -2,
          top: 48,
          width: SQRT_5000,
      ...
      <img
        ...
        className={cn("mb-4 h-14 w-12 object-cover object-top", isCenter ? "bg-gray-200" : "bg-gray-800")}
        style={{
          boxShadow: isCenter ? "3px 3px 0px rgb(0, 0, 0)" : "3px 3px 0px rgb(30, 30, 30)",
        }}
      />
      <h3 className={cn("text-base sm:text-xl font-medium", isCenter ? "text-black" : "text-white")}>
